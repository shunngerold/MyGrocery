...
<div class="max-w-[18rem] bg-lime-50 rounded-lg shadow-xl">
    <a href="#">
        <img class="p-8 rounded-lg" src="{{asset('images/free_home_delivery.jpg')}}" alt="product image" />
    </a>
    <div class="px-5 pb-5">
        <a href="#">
        ...
        <div class="flex items-center justify-between">
            ...
            <a href="#" class="text-white bg-[#239807] hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Add to cart</a>
        </div>
    </div>
</div>